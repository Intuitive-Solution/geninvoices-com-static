      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div class="lg:col-span-1">
          <div class="flex items-center space-x-2 mb-4">
            ...
            <span class="text-xl font-bold">Geninvoices</span>
          </div>
          <p class="text-gray-300 mb-4">
            Generate professional invoices quickly and easily. Streamline your billing process with our smart invoice generation platform.
          </p>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><NuxtLink to="/features" class="text-gray-300 hover:text-white transition-colors duration-200">Features</NuxtLink></li>
            <li><NuxtLink to="/pricing" class="text-gray-300 hover:text-white transition-colors duration-200">Pricing</NuxtLink></li>
            <li><a href="#" class="text-gray-300 hover:text-white transition-colors duration-200">API Documentation</a></li>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><NuxtLink to="/about" class="text-gray-300 hover:text-white transition-colors duration-200">About Us</NuxtLink></li>
            <li><NuxtLink to="/contact" class="text-gray-300 hover:text-white transition-colors duration-200">Contact</NuxtLink></li>
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li><a href="#" class="text-gray-300 hover:text-white transition-colors duration-200">Community</a></li>
          </ul>
        </div>
      </div>
